	...
	<ul class="list-group">
		...
		<%
			if (user.get_cardNumber() == null) {
				...
				out.print("<li class='list-group-item'><strong>Linked Card: </strong>" + user.get_cardNumber()
						+ "<form action='UserDAOController' method='post'>"
						+ "<input type='hidden' name='action' value='unlink'>"
						+ "<input type='submit' value='Unlink'>" + "</li>");
			}
		%>
	</ul>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><a class="nav-link text-primary"
					href="linkCard.jsp">Link Card</a></li>
				<li class="nav-item dropdown"><a class="nav-link text-primary"
					href="listAlerts.jsp">Show Alerts</a></li>
