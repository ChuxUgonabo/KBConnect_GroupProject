...
public class Order {
	...
	/*
	 * reference database table mysql> desc orders;
	 * +-----------------+--------------+------+-----+---------+----------------+ |
	 * Field | Type | Null | Key | Default | Extra |
	 * +-----------------+--------------+------+-----+---------+----------------+ |
	 * id | int(11) | NO | PRI | NULL | auto_increment | | description |
	 * varchar(255) | YES | | NULL | | | quantity | int(11) | YES | | NULL | | |
	 * unitPrice | double(5,2) | YES | | NULL | | | amount | double(6,2) | YES | |
	 * NULL | | | transactionDate | date | YES | | NULL | |
	 * +-----------------+--------------+------+-----+---------+----------------+ 6
