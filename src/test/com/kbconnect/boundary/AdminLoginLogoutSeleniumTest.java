...
/**
 * selenium testing for amdin login and logout
 */
...
import java.net.URL;
public class AdminLoginLogoutSeleniumTest {
  ...
  public void adminLoginLogout() {
	  ...
	  driver.get("http://localhost:8080/KBPayment_GroupProject/adminLogin.jsp");
	    ...
	    assertThat(driver.findElement(By.cssSelector("h4")).getText(), CoreMatchers.containsString("You have been logged out."));
	    driver.close();
